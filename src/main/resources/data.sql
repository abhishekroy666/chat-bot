--NO_NAME
insert into response (created_by, modified_by, created_date, modified_date, message_type, text) values
...
('SYSTEM', 'SYSTEM', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'BLANK', 'Hello! Are you there?'),
